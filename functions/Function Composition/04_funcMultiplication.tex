...
\begin{definition}
    Given two functions $f$ and $g$, their sum $(f \cdot g)(x)$ can be defined as
    \[
...
\begin{solution}
    ...
    \clearpage
    Now for $g$. The function $g$ is a radical function, meaning the radicand cannot be less than $0$. So I can set the radicant equal to $0$ and solve for $x$.
    \begin{align*}
        3x^2 - 1 &= 0 \\
        3x^2 &= 1 \\
        x^2 &= \frac{1}{3} \\
    ...
    \end{align*}
    We're looking for a minimum value, so we'll use $x = -\frac{\sqrt{3}}{3}$. This is, indeed, the smallest value of $x$ that satisfies the equation.
    \begin{align*}
